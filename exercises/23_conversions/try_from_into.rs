...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        if tuple.0 >= 0 && tuple.0 <= u8::MAX as i16 && tuple.1 >= 0 && tuple.1 <= u8::MAX as i16 && tuple.2 >= 0 && tuple.2 <= u8::MAX as i16 {
            return Ok(Color { 
                red: tuple.0 as u8, 
                green: tuple.1 as u8, 
                blue: tuple.2 as u8 
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        if arr[0] < 0 || arr[0] > u8::MAX as i16 || arr[1] < 0 || arr[1] > u8::MAX as i16 || arr[2] < 0 || arr[2] > u8::MAX as i16 {
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        if slice.len() != 3 {
            ...
            if slice[0] < 0 || slice[0] > u8::MAX as i16 || slice[1] < 0 || slice[1] > u8::MAX as i16 || slice[2] < 0 || slice[2] > u8::MAX as i16 {
                Err(IntoColorError::IntConversion)
            } else {
                Ok(Color {
                    red: slice[0] as u8,
